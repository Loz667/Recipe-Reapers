...
namespace RPG.Combat
{
    public class BattleSystem : MonoBehaviour
    {
        ...
        private const string WIN_MSG = "All monsters have been satisfied!";
        ...
        private IEnumerator FeedRoutine(int i)
        {
            ...
            if (allBattlers[i].IsPlayer == true)
            {
                ...
                {
                    currTarget.BattleVisuals.PlayFullAnim();
        ...
        public void ShowBattleMenu()
        {
            ...
            GameObject feedButton = GameObject.Find("Feed");
            EventSystem.current.SetSelectedGameObject(feedButton);
        }
        ...
        public void ShowEnemySelectMenu()
        {
            ...
            GameObject enemyButton = GameObject.Find("Enemy_1");
